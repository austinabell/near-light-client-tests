...
function blockHeaderInnerLiteHash(data) {
    ...
    hash.update(new bn_js_1.BN(data.height).toArrayLike(Buffer, "le", 8));
    ...
    hash.update(new bn_js_1.BN(data.timestamp_nanosec || data.timestamp).toArrayLike(Buffer, "le", 8));
