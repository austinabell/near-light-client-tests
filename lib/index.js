...
exports.validateExecutionProof = exports.validateLightClientBlock = void 0;
...
function validateExecutionProof(proof) {
    ...
    if (!blockMerkleRoot.equals(bs58_1.default.decode(proofMerkleRoot))) {
        throw new Error(`Block merkle root (${bs58_1.default.encode(blockMerkleRoot)}) doesn't match proof (${proofMerkleRoot})}`);
    }
}
